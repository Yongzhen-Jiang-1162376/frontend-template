...
import { AlignJustify, X, Ellipsis, Flag } from "lucide-react";
  ...
  return (
    <header className="sticky top-0 w-full bg-white flex border-gray-200 z-99999 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 sm:gap-4">
          <button
        ...
        <div
          ...
          } items-center justify-end w-full gap-4 px-5 py-4`}
        >
          User Dropdown
        </div>
      </div>
